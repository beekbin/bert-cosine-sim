...
class FeedProcessor(DataProcessor):
    """Processor for the Feeds data set."""
...
# a map from task_name to data_processor.
processors = {
    "cola": ColaProcessor,
    "mnli": MnliProcessor,
